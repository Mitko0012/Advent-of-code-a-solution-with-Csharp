...
Regex regex = new Regex(@"\d|one|two|three|four|five|six|seven|eight|nine", RegexOptions.IgnoreCase);
Regex regex2 = new Regex(@"\d|one|two|three|four|five|six|seven|eight|nine", RegexOptions.RightToLeft);
